...
// wall heat dissipation equations
  ...
  model RoomHeating
    RoomWithFCU_Hassan_1.Wall wall annotation(Placement(visible = true, transformation(origin = {-14, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    RoomWithFCU_Hassan_1.Room room annotation(Placement(visible = true, transformation(origin = {45, 5}, extent = {{-23, -23}, {23, 23}}, rotation = 0)));
  ...
  Modelica.Blocks.Interfaces.RealOutput RAT annotation(Placement(visible = true, transformation(origin = {108, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {108, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(room.RAT, RAT) annotation(Line(points = {{68, 4}, {90, 4}, {90, 0}, {108, 0}, {108, 0}}, color = {0, 0, 127}));
    connect(room.RAT, wall.RAT) annotation(Line(points = {{68.92, 4.54}, {79.92, 4.54}, {79.92, 33.54}, {-38.08, 33.54}, {-38.08, 49.54}, {-24.08, 49.54}}, color = {0, 0, 127}));
    ...
    connect(OAT, wall.OAT) annotation(Line(points = {{-100, 56}, {-40, 56}, {-40, 60}, {-24, 60}, {-24, 60}}, color = {0, 0, 127}));
    connect(wall.Tisurf, room.Tisurf) annotation(Line(points = {{-3.6, 54}, {4.4, 54}, {4.4, 18}, {24.4, 18}, {24.4, 18}}, color = {0, 0, 127}));
    annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), uses(Modelica(version = "3.2.2")));
  end RoomHeating;
  ...
  model RoomwithFCU
    ...
    RoomWithFCU_Hassan_1.Wall wall1 annotation(Placement(visible = true, transformation(origin = {-14, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    RoomWithFCU_Hassan_1.Room room annotation(Placement(visible = true, transformation(origin = {45, 5}, extent = {{-23, -23}, {23, 23}}, rotation = 0)));
